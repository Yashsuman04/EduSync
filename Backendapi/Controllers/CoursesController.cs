...
namespace Backendapi.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public CoursesController(AppDbContext context, ILogger<CoursesController> logger, TelemetryClient telemetryClient)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> PutCourse(Guid id, CourseCreateDto courseDto)
        {
            ...
            try
            {
                ...
                {
                    _telemetryClient.TrackEvent("CourseIdMismatch", new Dictionary<string, string>
                    {
                        { "RequestedId", id.ToString() },
                        { "DtoId", courseDto.CourseId.ToString() }
                    });
