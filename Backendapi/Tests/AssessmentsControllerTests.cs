...
namespace Backendapi.Tests.Controllers
{
    ...
    public class AssessmentsControllerTests
    {
        ...
        [Test]
        public async Task DeleteAssessment_WithValidId_DeletesAssessment()
        {
            // Arrange
            var assessmentId = Guid.NewGuid();
            var assessment = new Assessment
        ...
        [Test]
        public async Task DeleteAssessment_WithInvalidId_ReturnsNotFound()
        {
            // Act
            ...
            Assert.That(response.message, Is.EqualTo("Error deleting assessment"));
        }
